...
if not exist .touchsam (
    ...
    echo %BLUE%Installing TensorRT...%RESET%
    python -m pip install tensorrt || echo %RED%TensorRT installation failed%RESET%
    ...
    call .touchsam\Scripts\activate.bat
    echo %BLUE%Optimizing model...%RESET%
    python optimize_model.py
    echo %GREEN%Optimization complete.%RESET%
)
pause
